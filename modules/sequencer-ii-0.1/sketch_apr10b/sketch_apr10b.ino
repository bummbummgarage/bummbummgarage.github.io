...
// https://www.youtube.com/watch?v=U3ccR3xbJSQ


char msg[] ="EASY TECH ";//Change the text here.
...
//Columns
int clockPin1 = 3; // SHCP
int latchPin1 = 4; // STCP
int dataPin1 = 7;  // DS

//Rows
int clockPin2 = 8; // SHCP
int latchPin2 = 11; // STCP
int dataPin2 = 12;  // DS
